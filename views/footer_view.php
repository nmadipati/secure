    ...
    <div id="footer-widgets">
        <div class="container">
                    ...
                    <aside class="widget-area span12">
                        <div id="text-2" class="widget widget-footer widget_text">
                            <div class="textwidget">
                                <div>
                                    <div>
                                        <table border="0" height="76" width="1171">
                                            <tbody>
                                                <tr>
                                                    <td width="275">
                                                        <img src="http://www.salmaforex.com/wp-content/uploads/2015/09/logo1.png" height="47" width="220">
                                                    </td>
                                                    <td width="108"><a href="http://www.salmaforex.com/privaci-policy/" target="_blank">Privacy Policy</a>
                                                    </td>
                                                    <td width="199"><a href="http://www.salmaforex.com/terms-and-conditions/">Terms &amp; Conditions</a>
                                                        <br>
                                                    </td>
                                                    <td width="43"><a href="#"></a>
                                                    </td>
                                                    <td width="131">&nbsp;</td>
                                                    <td width="50">&nbsp;</td>
                                                    <td width="335">Copyright © SalmaForex 2015. All rights reserved</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
            ...
            <div id="footer-widgets-row2">
                <div class="ui-row row"></div>
            </div>
        </div>
    </div>
    <div id="footer-bottom" class="">
        <div class="container">
            <div id="footer-texts" class="pull-left"><strong>SalmaForex Partners</strong> -The leading forex broker © 2015</div>
        </div>
    </div>
</footer>